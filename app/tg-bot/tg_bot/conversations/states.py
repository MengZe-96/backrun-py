...
class CopyTradeStates(StatesGroup):
    ...
    CREATE_WAITING_FOR_MAX_POSITION = State() # 创建时等待输入最大仓位
    ...
    EDIT_WAITING_FOR_MIN_BUY_SOL = State()  # 编辑时等待输入最小买入数量
    EDIT_WAITING_FOR_MAX_BUY_SOL = State()  # 编辑时等待输入最大买入数量
    EDIT_WAITING_FOR_MAX_BUY_TIME = State() # 编辑时等待输入最大买入次数
    EDIT_WAITING_FOR_MAX_POSITION = State() # 编辑时等待输入最大仓位
    EDIT_WAITING_FOR_MIN_SELL_RATIO = State()  # 编辑时等待输入最小卖出比例
